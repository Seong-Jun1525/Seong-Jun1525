...
- **프로젝트 설명**
  ```
  매장에서 긴 줄을 기다리지 않고 QR코드를 활용하여 상품을 장바구니 담아
  현장에서 바로 결제할 수 있는 애플리케이션입니다.

  관리자 모드로 회원, 상품 등을 관리할 수 있도록 개발하였습니다.
  ```
- **사용한 기술**: Java, Android Studio, JavaScript, Firebase 등
- 🧩 담당 업무
    - **⭐ 프로젝트 관리자로서**
      - 프로젝트 기획 및 총괄
      - 전반적인 프로젝트 방향성 확립
      - 프로젝트 문서 및 발표자료 작업, 발표 전담
      - **${\textsf{\color{gold}프로젝트 개발에 가장 큰 기여}}$**
    - **🧑‍💻 풀스택 개발자로서**
      - **상품 리뷰 기능**: 리뷰 등록/삭제, 평점 계산, 리뷰 데이터베이스 설계
      - **관리자 다크 모드**: 다크 모드 UI 구현 및 설정 기능 개발
      - **주요 기능 구현**: 매장 위치 검색, 개인 결제 내역, 회원 구매 내역, 알림창 기능 개발
      - 데이터베이스 작업: 관리자 Todo 및 상품 리뷰 DB 구축
      - UI 디자인: 관리자·회원 페이지, 리뷰·결제·상품 상세 페이지 디자인
